...
public class MySqlDatabase
{
   ...
   private String uri = null; //"jdbc:mysql://localhost/travel2?autoReconnect=true&useSSL=false&useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
...
//    }  
   ...
   { 
      ...
      {
         errorMessage.add("java.MySqlDatabase.startTrans: " + sqle.getMessage());
   ...
   public boolean endTrans() throws DLException
   {
      ...
      {
         errorMessage.add("java.MySqlDatabase.endTrans: " + sqle.getMessage());
         throw new DLException(sqle, errorMessage);
      } 
   }
   ...
   public boolean rollbackTrans() throws DLException
   {
      ...
      {
         errorMessage.add("java.MySqlDatabase.rollbackTrans: " + sqle.getMessage());
         throw new DLException(sqle, errorMessage);
      } 
   }
}